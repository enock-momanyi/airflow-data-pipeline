...
COPY_MONTHLY_TRIPS_SQL = COPY_SQL.format(
    "trips",
    "s3://airflow-bucket-enock/data-pipelines/divvy/partitioned/{year}/{month}/divvy_trips.csv"
)

COPY_ALL_TRIPS_SQL = COPY_SQL.format(
    "trips",
    "s3://airflow-bucket-enock/data-pipelines/divvy/unpartitioned/divvy_trips_2018.csv"
)

COPY_STATIONS_SQL = COPY_SQL.format(
    "stations",
    "s3://airflow-bucket-enock/data-pipelines/divvy/unpartitioned/divvy_stations_2017.csv"
)
