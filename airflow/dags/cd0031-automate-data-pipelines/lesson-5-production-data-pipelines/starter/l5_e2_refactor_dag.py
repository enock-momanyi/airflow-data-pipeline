...
#
    @task()
    def load_young_riders(*args, **kwargs):
    ...
    load_young_riders_task = load_young_riders()
    youngest_rider_task = youngest_rider()
    load_lifetime_rides_task = load_lifetime_rides()
    load_city_stations_task = load_city_stations()

    load_young_riders_task >> youngest_rider_task
